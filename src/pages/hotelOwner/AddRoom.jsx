...
const AddRoom = () => {
    ...
    return (
        <form>
            <Title align='left' font='outfit' title='Add Room' subTitle='Fill the details carefully and accurate to enhance booking experience.'/>
            ...
            <div className="w-full flex max-sm:flex-col sm:gap-4 mt-4">
                ...
                <div>
                    <p className="mt-4 text-gray-800">
                        ...
                        <input type="number" placeholder="0"m className="border border-gray-300 mt-1 rounded p-2 w-24" value={inputs.pericePerNight} onChange={e=> setInputs({...inputs, pericePerNight: e.target.value})}/>
                    </p>
                </div>
            </div>
            <p className="text-gray-800 mt-4">Amenities</p>
            <div className="flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm">
                {Object.key(inputs.amenities).map((amenity, index)=>(
                    <div key={index}>
