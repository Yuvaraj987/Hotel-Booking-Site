...
const FeaturedDestination = () => {
    ...
    return (
        <div className='flex flex-col items-center px-3 md:px-16 lg:px-15 bg-slate-50 py-10'>
            
            <Title title='Featured Destination' subTitle='Discover our exceptional properties around the world, offering luxury and unforgettable experience.'/>
